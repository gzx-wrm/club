...
import com.gzx.club.auth.infra.basic.mapper.AuthPermissionDao;
...
public class AuthPermissionServiceImpl implements AuthPermissionService {
    ...
    @Override
    public List<AuthPermission> queryByIds(List<Long> permissionIdList) {
        return this.authPermissionDao.queryByIds(permissionIdList);
    }
}
