...
import com.gzx.club.subject.application.convert.SubjectAnswerDTOConverter;
import com.gzx.club.subject.application.convert.SubjectInfoDTOConverter;
import com.gzx.club.subject.application.dto.SubjectInfoDTO;
import com.gzx.club.subject.common.entity.PageResult;
import com.gzx.club.subject.common.entity.Result;
...
public class SubjectController {
    ...
    public Result<PageResult<EsSubjectInfo>> getSubjectPageBySearch(@RequestBody SubjectInfoDTO subjectInfoDTO) {
        try {
            if (log.isInfoEnabled()) {
            ...
            SubjectInfoBO subjectInfoBO = SubjectInfoDTOConverter.INSTANCE.convertDTOToBO(subjectInfoDTO);
            PageResult<EsSubjectInfo> boPageResult = subjectInfoDomainService.getSubjectPageBySearch(subjectInfoBO);
            return Result.ok(boPageResult);
        } catch (Exception e) {
    ...
    public Result<List<SubjectInfoDTO>> getContributeList() {
        try {
            ...
            List<SubjectInfoDTO> dtoList = SubjectInfoDTOConverter.INSTANCE.convertBOToDTO(boList);
