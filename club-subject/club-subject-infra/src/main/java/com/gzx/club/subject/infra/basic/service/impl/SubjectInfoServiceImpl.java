...
import com.gzx.club.subject.infra.basic.mapper.SubjectInfoDao;
...
public class SubjectInfoServiceImpl implements SubjectInfoService {
    ...
    @Override
    public long countByCondition(SubjectInfo subjectInfo, Long categoryId, Long labelId) {
        return this.subjectInfoDao.countByCondition(subjectInfo, categoryId, labelId);
    }

    @Override
    public List<SubjectInfo> queryPage(SubjectInfo subjectInfo, Long categoryId, Long labelId, Integer offset, Integer limit) {
        return this.subjectInfoDao.queryPage(subjectInfo, categoryId, labelId, offset, limit);
    }
